...
### GPT-IMAGE-1 prompt (copy/paste-ready)
```
...
`![Living room repaint placeholder](./images/living-room-repaint-16x9.png)`
...
`![Bathroom mirror replacement placeholder](./images/bathroom-mirror-replace-16x9.png)`
...
`![Kitchen backsplash update placeholder](./images/kitchen-backsplash-16x9.png)`
