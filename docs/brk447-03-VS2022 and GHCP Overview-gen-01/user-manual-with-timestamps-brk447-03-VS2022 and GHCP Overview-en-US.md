...
2. Confirm the Copilot extension is running; you should see inline suggestion UI while you type and prompts for the “next edit.”
   ...
   - Snapshot: ![Copilot inline suggestions and next-edit UI](./%5B00%3A00%3A08.000%5D)
...
3. Verify other available quotas or resources shown in the panel.
   - Snapshot: ![Consumption/usage panel with pro plan meter](./%5B00%3A00%3A25.000%5D)
...
1. Open the solution explorer to view project components:
   ...
   - Snapshot: ![Solution/project structure showing orchestrators, backend, front end, models](./%5B00%3A00%3A45.000%5D)
...
4. Choose the desired model (example: select GPT-5 from the list).
   ...
   - Snapshot: ![Model selector open with GPT-5 selected](./%5B00%3A01%3A12.000%5D)
...
4. When ready, switch to Agent mode and instruct Copilot to apply the changes:
   ...
   - Snapshot: ![Copilot analysis/upgrade plan and apply-changes UI](./%5B00%3A02%3A15.000%5D)
...
- Inline snapshot: Copilot inline suggestions and next-edit UI — [00:00:08.000]
- Inline snapshot: Consumption/usage panel with pro plan meter — [00:00:25.000]
- Inline snapshot: Solution/project structure (orchestrators, backend, front end, models) — [00:00:45.000]
- Inline snapshot: Model selector open, GPT-5 selected — [00:01:12.000]
- Inline snapshot: Copilot analysis and upgrade plan / apply-changes UI — [00:02:15.000]
