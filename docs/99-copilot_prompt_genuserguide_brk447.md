...
Generate a Markdown guide for session BRK-447, which covers a real-world scenario using Visual Studio and GitHub Copilot.
The guide should be created in [docs\BRK447-Presenter-Guide.md], if the file exists update the existing file.
Use the repository files as context.

The guide should instruct the speaker to:
...
Make the guide useful and easy to follow for a technical presenter.
